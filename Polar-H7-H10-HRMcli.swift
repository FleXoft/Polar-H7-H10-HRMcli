...
func myNotify( title: String, body: String ) {
...
class BluetoothManager: NSObject, CBPeripheralDelegate, CBCentralManagerDelegate {
    ...
    required init( withManager manager : CBCentralManager = CBCentralManager() ) {    
        super.init()
...
// let lastPeripherals = centralManager.retrieveConnectedPeripherals(withServices: serviceUUIDs as! [CBUUID])
            ...
            if lastPeripherals.count > 0 {
                ...
                myNotify( title: "Polar-H7-H10-HRMcli", body: "-- Start scanning..." )
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        myNotify( title: "Polar-H7-H10-HRMcli", body: "Found H7 or H10!" )
